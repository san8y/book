      ...
      <div className="library-hero-card">
        <div className="library-hero-content">
          ...
          <div className="library-hero-text">
            ...
            >
              <span className="text-3xl font-light mb-1 mr-2">
                +
              </span>
          ...
          <div className="library-steps-card min-w-[260px] max-w-[280px] z-10 shadow-soft-md">
            <ul className="space-y-6">
              ...
              <li className="library-step-item flex gap-4">
                <div className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center font-medium text-lg">
                  1
                </div>
